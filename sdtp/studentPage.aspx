<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="studentPage.aspx.cs" Inherits="sdtp.studentPage" %>
                         ...
                         <div class="nav-wrapper ">
                             <ul class="nav nav-tabs" role="tablist">
                                 <li class="nav-item" role="presentation">
                                     <button class="nav-link active" id="studentfeed-tab" data-bs-toggle="tab" data-bs-target="#studentfeed" type="button" role="tab" aria-controls="studentfeed" aria-selected="true">Student Feed</button>
                                 </li>
                                 <li class="nav-item" role="presentation">
                             ...
                             <div class="tab-pane fade" id="Hostel" role="tabpanel" aria-labelledby="Hostel-tab">
                                 <div class="row">
                                     ...
                                     <div class="col-lg-3">
                                         ...
                                         <p>Admin Aosts articles here to improve awareness about finding proper accommodations.
                                             <br>
                                             <br>
                                            </p>
                                         <div class="icon-button">
                             ...
                             <div class="tab-pane fade" id="House" role="tabpanel" aria-labelledby="House-tab">
                                 <div class="row">
                                     ...
                                     <div class="col-lg-3">
                                         ...
                                         <p>Barnd new house . near to NSBM green University. Attch 5 bathrooms, 5 Bedrooms, 2 parking slots with 1 Garage. Also have a kitchen. AC and Normal Fans, Solar Powered System.
                                             <br>
